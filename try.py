...
def menu(my_name,my_id):
	...
	print(x+'['+h+'•'+x+'] IP ANDDRES  : '+str(sh['origin']))
	io = '''[bold green][01] CRACK FRINDS ID PUBLIK	    
[02] CRACK ID PUBLIK (MASAL)   		     [bold green]'''
...
def cekopsii(id,pw,ttl):
		try:
			...
			print('')
			li = '# KONEKSI BERMASALAH JARINGGAN, PERIKSA & COBA LAGI'
			sol().print(mark(li, style='red'))
			exit()
